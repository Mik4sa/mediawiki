...
CREATE TABLE /*_*/slots (
  ...
  slot_role_id smallint NOT NULL CONSTRAINT FK_slots_slot_role FOREIGN KEY REFERENCES /*_*/slot_roles(role_id),

  -- reference to content_id
  slot_content_id bigint NOT NULL CONSTRAINT FK_slots_content_id FOREIGN KEY REFERENCES /*_*/content(content_id),
...
CREATE TABLE /*_*/filearchive (
  ...
  fa_description_id bigint NOT NULL CONSTRAINT DF_fa_description_id DEFAULT 0 CONSTRAINT FK_fa_description FOREIGN KEY REFERENCES /*_*/comment(comment_id),
